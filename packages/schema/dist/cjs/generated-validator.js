...
exports.validate_variable = validate_variable;
exports.validate_booleanOrVariable = validate_booleanOrVariable;
exports.validate_theme = validate_theme;
exports.validate_color = validate_color;
exports.validate_colorOrVariable = validate_colorOrVariable;
exports.validate_numberOrVariable = validate_numberOrVariable;
exports.validate_stringOrVariable = validate_stringOrVariable;
exports.validate_position = validate_position;
exports.validate_canHaveRotation = validate_canHaveRotation;
exports.validate_entity = validate_entity;
exports.validate_sizingBehavior = validate_sizingBehavior;
exports.validate_size = validate_size;
exports.validate_blendMode = validate_blendMode;
exports.validate_effect = validate_effect;
exports.validate_effects = validate_effects;
exports.validate_canHaveEffects = validate_canHaveEffects;
exports.validate_fill = validate_fill;
exports.validate_fills = validate_fills;
exports.validate_stroke = validate_stroke;
exports.validate_canHaveGraphics = validate_canHaveGraphics;
exports.validate_rectangleish = validate_rectangleish;
exports.validate_layout = validate_layout;
exports.validate_group = validate_group;
exports.validate_rectangle = validate_rectangle;
exports.validate_ellipse = validate_ellipse;
exports.validate_line = validate_line;
exports.validate_path = validate_path;
exports.validate_polygon = validate_polygon;
exports.validate_textStyle = validate_textStyle;
exports.validate_textContent = validate_textContent;
exports.validate_text = validate_text;
exports.validate_note = validate_note;
exports.validate_prompt = validate_prompt;
exports.validate_context = validate_context;
exports.validate_iconFont = validate_iconFont;
exports.validate_idPath = validate_idPath;
exports.validate_ref = validate_ref;
exports.validate_child = validate_child;
exports.validate_canHaveChildren = validate_canHaveChildren;
exports.validate_frame = validate_frame;
exports.validate_connectionAnchor = validate_connectionAnchor;
exports.validate_connectionEndpoint = validate_connectionEndpoint;
exports.validate_connection = validate_connection;
exports.validate_document = validate_document;
function validate_variable(v, ctx, path) {
    if (typeof v !== "string") {
...
function validate_booleanOrVariable(v, ctx, path) {
    if (typeof v === "string") {
        const _v0 = { errors: [], partial: ctx.partial };
        let _v1 = false;
        if (!_v1) {
            const _v2 = { errors: [], partial: _v0.partial };
            validate_variable(v, _v2, path);
            if (_v2.errors.length === 0)
                _v1 = true;
        }
        if (!_v1) {
...
function validate_theme(v, ctx, path) {
...
function validate_color(v, ctx, path) {
    if (typeof v !== "string") {
...
function validate_colorOrVariable(v, ctx, path) {
    let _v5 = false;
    if (!_v5) {
        const _v6 = { errors: [], partial: ctx.partial };
        validate_color(v, _v6, path);
        if (_v6.errors.length === 0)
            _v5 = true;
    }
    if (!_v5) {
        const _v7 = { errors: [], partial: ctx.partial };
        validate_variable(v, _v7, path);
        if (_v7.errors.length === 0)
            _v5 = true;
    }
    if (!_v5) {
...
function validate_numberOrVariable(v, ctx, path) {
    if (typeof v === "string") {
        const _v8 = { errors: [], partial: ctx.partial };
        let _v9 = false;
        if (!_v9) {
            const _v10 = { errors: [], partial: _v8.partial };
            validate_variable(v, _v10, path);
            if (_v10.errors.length === 0)
                _v9 = true;
        }
        if (!_v9) {
...
function validate_stringOrVariable(v, ctx, path) {
    let _v11 = false;
    if (!_v11) {
        const _v12 = { errors: [], partial: ctx.partial };
        if (typeof v !== "string") {
            _v12.errors.push({ path: path, message: "expected string" + ", got " + JSON.stringify(v) });
        }
        if (_v12.errors.length === 0)
            _v11 = true;
    }
    if (!_v11) {
        const _v13 = { errors: [], partial: ctx.partial };
        validate_variable(v, _v13, path);
        if (_v13.errors.length === 0)
            _v11 = true;
    }
    if (!_v11) {
...
function validate_position(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
function validate_canHaveRotation(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
function validate_entity(v, ctx, path) {
...
function validate_sizingBehavior(v, ctx, path) {
    if (typeof v !== "string") {
...
function validate_size(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
        ...
        if (_v18["width"] !== undefined) {
            const _v19 = { errors: [], partial: ctx.partial };
            let _v20 = false;
            if (!_v20) {
                const _v21 = { errors: [], partial: _v19.partial };
                validate_numberOrVariable(_v18["width"], _v21, path + "/width");
                if (_v21.errors.length === 0)
                    _v20 = true;
            }
            if (!_v20) {
                const _v22 = { errors: [], partial: _v19.partial };
                validate_sizingBehavior(_v18["width"], _v22, path + "/width");
                if (_v22.errors.length === 0)
                    _v20 = true;
            }
            if (!_v20) {
            ...
            if (_v19.errors.length > 0 && ctx.transform) {
                ...
                let _v24 = false;
                if (!_v24) {
                    const _v25 = { errors: [], partial: ctx.partial };
                    validate_numberOrVariable(_v18["width"], _v25, path + "/width");
                    if (_v25.errors.length === 0)
                        _v24 = true;
                }
                if (!_v24) {
                    const _v26 = { errors: [], partial: ctx.partial };
                    validate_sizingBehavior(_v18["width"], _v26, path + "/width");
                    if (_v26.errors.length === 0)
                        _v24 = true;
                }
                if (!_v24) {
                ...
                for (const _e of _v19.errors)
                    ctx.errors.push(_e);
            }
        }
        if (_v18["height"] !== undefined) {
            const _v27 = { errors: [], partial: ctx.partial };
            let _v28 = false;
            if (!_v28) {
                const _v29 = { errors: [], partial: _v27.partial };
                validate_numberOrVariable(_v18["height"], _v29, path + "/height");
                if (_v29.errors.length === 0)
                    _v28 = true;
            }
            if (!_v28) {
                const _v30 = { errors: [], partial: _v27.partial };
                validate_sizingBehavior(_v18["height"], _v30, path + "/height");
                if (_v30.errors.length === 0)
                    _v28 = true;
            }
            if (!_v28) {
            ...
            if (_v27.errors.length > 0 && ctx.transform) {
                ...
                let _v32 = false;
                if (!_v32) {
                    const _v33 = { errors: [], partial: ctx.partial };
                    validate_numberOrVariable(_v18["height"], _v33, path + "/height");
                    if (_v33.errors.length === 0)
                        _v32 = true;
                }
                if (!_v32) {
                    const _v34 = { errors: [], partial: ctx.partial };
                    validate_sizingBehavior(_v18["height"], _v34, path + "/height");
                    if (_v34.errors.length === 0)
                        _v32 = true;
                }
                if (!_v32) {
                ...
                for (const _e of _v27.errors)
                    ctx.errors.push(_e);
            }
        }
    }
}
function validate_blendMode(v, ctx, path) {
...
function validate_effect(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
            ...
            case "shadow":
                if (typeof v !== "object" || v === null) {
                    ...
                    if (_v40["color"] !== undefined) {
                        const _v43 = { errors: [], partial: ctx.partial };
...
function validate_effects(v, ctx, path) {
    if (Array.isArray(v)) {
...
function validate_canHaveEffects(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
function validate_fill(v, ctx, path) {
    let _v48 = false;
    if (!_v48) {
        const _v49 = { errors: [], partial: ctx.partial };
        validate_colorOrVariable(v, _v49, path);
        if (_v49.errors.length === 0)
            _v48 = true;
    }
    if (!_v48) {
        if (typeof v !== "object" || v === null) {
                ...
                case "color":
                    if (typeof v !== "object" || v === null) {
                        ...
                        if (!ctx.partial && !("color" in _v51)) {
                            ...
                            const _v52 = { errors: [], partial: ctx.partial };
                                ...
                                for (let _v58 = 0; _v58 < _v55["colors"].length; _v58++) {
                                    if (typeof _v55["colors"][_v58] !== "object" || _v55["colors"][_v58] === null) {
                                        ...
                                        if (!ctx.partial && !("color" in _v59)) {
                                            ...
                                            const _v60 = { errors: [], partial: ctx.partial };
                        ...
                        if (_v66["colors"] !== undefined) {
                            if (!Array.isArray(_v66["colors"])) {
                                ...
                                for (let _v67 = 0; _v67 < _v66["colors"].length; _v67++) {
                                    const _v68 = { errors: [], partial: ctx.partial };
...
function validate_fills(v, ctx, path) {
    if (Array.isArray(v)) {
        for (let _v80 = 0; _v80 < v.length; _v80++) {
            const _v81 = { errors: [], partial: ctx.partial };
...
function validate_stroke(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
        ...
        if (_v83["thickness"] !== undefined) {
            let _v84 = false;
            if (!_v84) {
                const _v85 = { errors: [], partial: ctx.partial };
                validate_numberOrVariable(_v83["thickness"], _v85, path + "/thickness");
                if (_v85.errors.length === 0)
                    _v84 = true;
            }
            if (!_v84) {
                const _v86 = { errors: [], partial: ctx.partial };
        ...
        if (_v83["fill"] !== undefined) {
            const _v90 = { errors: [], partial: ctx.partial };
...
function validate_canHaveGraphics(v, ctx, path) {
    ...
    if (typeof v !== "object" || v === null) {
        ...
        if (_v93["fill"] !== undefined) {
            const _v94 = { errors: [], partial: ctx.partial };
            ...
            if (_v94.errors.length > 0 && ctx.transform) {
                ...
                for (const _e of _v94.errors)
                    ctx.errors.push(_e);
            }
        }
    }
}
function validate_rectangleish(v, ctx, path) {
    ...
    if (typeof v !== "object" || v === null) {
        ...
        if (_v96["cornerRadius"] !== undefined) {
            if (Array.isArray(_v96["cornerRadius"])) {
                ...
                const _v98 = { errors: [], partial: ctx.partial };
                let _v99 = false;
                if (!_v99) {
                    const _v100 = { errors: [], partial: _v98.partial };
                    validate_numberOrVariable(_v96["cornerRadius"], _v100, path + "/cornerRadius");
                    if (_v100.errors.length === 0)
                        _v99 = true;
                }
                if (!_v99) {
...
function validate_layout(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
        ...
        if (_v101["padding"] !== undefined) {
            if (Array.isArray(_v101["padding"])) {
                let _v102 = false;
                if (!_v102) {
                    const _v103 = { errors: [], partial: ctx.partial };
                    ...
                    if (_v103.errors.length === 0)
                        _v102 = true;
                }
                if (!_v102) {
                    const _v105 = { errors: [], partial: ctx.partial };
                ...
                const _v107 = { errors: [], partial: ctx.partial };
                let _v108 = false;
                if (!_v108) {
                    const _v109 = { errors: [], partial: _v107.partial };
                    validate_numberOrVariable(_v101["padding"], _v109, path + "/padding");
                    if (_v109.errors.length === 0)
                        _v108 = true;
                }
                if (!_v108) {
        ...
        if (_v101["justifyContent"] !== undefined) {
            const _v110 = { errors: [], partial: ctx.partial };
            ...
            if (_v110.errors.length > 0 && ctx.transform) {
                ...
                for (const _e of _v110.errors)
                    ctx.errors.push(_e);
            }
        }
        if (_v101["alignItems"] !== undefined) {
            const _v112 = { errors: [], partial: ctx.partial };
...
function validate_group(v, ctx, path) {
    ...
    if (typeof v !== "object" || v === null) {
        ...
        if (_v114["width"] !== undefined) {
            const _v115 = { errors: [], partial: ctx.partial };
            ...
            if (_v115.errors.length > 0 && ctx.transform) {
                ...
                for (const _e of _v115.errors)
                    ctx.errors.push(_e);
            }
        }
        if (_v114["height"] !== undefined) {
            const _v117 = { errors: [], partial: ctx.partial };
...
function validate_rectangle(v, ctx, path) {
...
function validate_ellipse(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
function validate_line(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
function validate_path(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
function validate_polygon(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
function validate_textStyle(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
        ...
        if (_v131["fontWeight"] !== undefined) {
            const _v132 = { errors: [], partial: ctx.partial };
        ...
        if (_v131["textAlign"] !== undefined) {
            const _v134 = { errors: [], partial: ctx.partial };
...
function validate_textContent(v, ctx, path) {
    if (Array.isArray(v)) {
        ...
        const _v141 = { errors: [], partial: ctx.partial };
        let _v142 = false;
        if (!_v142) {
            const _v143 = { errors: [], partial: _v141.partial };
            validate_stringOrVariable(v, _v143, path);
            if (_v143.errors.length === 0)
                _v142 = true;
        }
        if (!_v142) {
...
function validate_text(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    ...
    if (typeof v !== "object" || v === null) {
        ...
        if (_v144["textGrowth"] !== undefined) {
            const _v145 = { errors: [], partial: ctx.partial };
...
function validate_note(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_textStyle(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
function validate_prompt(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_textStyle(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
function validate_context(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_textStyle(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
function validate_iconFont(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveEffects(v, ctx, path);
    if (typeof v !== "object" || v === null) {
        ...
        if (_v154["fill"] !== undefined) {
            const _v155 = { errors: [], partial: ctx.partial };
...
function validate_idPath(v, ctx, path) {
    if (typeof v !== "string") {
...
function validate_ref(v, ctx, path) {
    validate_entity(v, ctx, path);
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
...
function validate_child(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
...
function validate_canHaveChildren(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
function validate_frame(v, ctx, path) {
    validate_rectangleish(v, ctx, path);
    validate_canHaveChildren(v, ctx, path);
    validate_layout(v, ctx, path);
    if (typeof v !== "object" || v === null) {
        ...
        if (_v165["slot"] !== undefined) {
            if (typeof _v165["slot"] === "boolean") {
                const _v166 = { errors: [], partial: ctx.partial };
                let _v167 = false;
                if (!_v167) {
                    const _v168 = { errors: [], partial: _v166.partial };
                    if (_v165["slot"] !== false) {
                        _v168.errors.push({ path: path + "/slot", message: "expected " + "false" + ", got " + JSON.stringify(_v165["slot"]) });
                    }
                    if (_v168.errors.length === 0)
                        _v167 = true;
                }
                if (!_v167) {
...
function validate_connectionAnchor(v, ctx, path) {
...
function validate_connectionEndpoint(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
function validate_connection(v, ctx, path) {
    validate_entity(v, ctx, path);
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
...
function validate_document(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
                                    ...
                                    if (typeof _v188[_v189] !== "object" || _v188[_v189] === null) {
                                        ...
                                        if (!ctx.partial && !("value" in _v191)) {
                                            ...
                                            if (Array.isArray(_v191["value"])) {
                                                ...
                                                const _v195 = { errors: [], partial: ctx.partial };
                                                let _v196 = false;
                                                if (!_v196) {
                                                    const _v197 = { errors: [], partial: _v195.partial };
                                                    validate_booleanOrVariable(_v191["value"], _v197, path + "/variables" + "/" + _v189 + "/value");
                                                    if (_v197.errors.length === 0)
                                                        _v196 = true;
                                                }
                                                if (!_v196) {
                                ...
                                case "color":
                                    if (typeof _v188[_v189] !== "object" || _v188[_v189] === null) {
                                        ...
                                        if (!ctx.partial && !("value" in _v199)) {
                                            ...
                                            const _v200 = { errors: [], partial: ctx.partial };
                                            if (Array.isArray(_v199["value"])) {
                                                for (let _v201 = 0; _v201 < _v199["value"].length; _v201++) {
                                                    if (typeof _v199["value"][_v201] !== "object" || _v199["value"][_v201] === null) {
                                                        ...
                                                        if (!_v200.partial && !("value" in _v202)) {
                                                            ...
                                                            const _v203 = { errors: [], partial: _v200.partial };
                                                            ...
                                                            if (_v203.errors.length > 0 && _v200.transform) {
                                                                ...
                                                                for (const _e of _v203.errors)
                                                                    _v200.errors.push(_e);
                                                            }
                                                        }
                                                ...
                                                const _v206 = { errors: [], partial: _v200.partial };
                                                let _v207 = false;
                                                if (!_v207) {
                                                    const _v208 = { errors: [], partial: _v206.partial };
                                                    validate_colorOrVariable(_v199["value"], _v208, path + "/variables" + "/" + _v189 + "/value");
                                                    if (_v208.errors.length === 0)
                                                        _v207 = true;
                                                }
                                                if (!_v207) {
                                            ...
                                            if (_v200.errors.length > 0 && ctx.transform) {
                                                ...
                                                if (Array.isArray(_v199["value"])) {
                                                    for (let _v210 = 0; _v210 < _v199["value"].length; _v210++) {
                                                        if (typeof _v199["value"][_v210] !== "object" || _v199["value"][_v210] === null) {
                                                            ...
                                                            if (!ctx.partial && !("value" in _v211)) {
                                                                ...
                                                                const _v212 = { errors: [], partial: ctx.partial };
                                                    ...
                                                    const _v215 = { errors: [], partial: ctx.partial };
                                                    let _v216 = false;
                                                    if (!_v216) {
                                                        const _v217 = { errors: [], partial: _v215.partial };
                                                        validate_colorOrVariable(_v199["value"], _v217, path + "/variables" + "/" + _v189 + "/value");
                                                        if (_v217.errors.length === 0)
                                                            _v216 = true;
                                                    }
                                                    if (!_v216) {
                                    ...
                                    if (typeof _v188[_v189] !== "object" || _v188[_v189] === null) {
                                        ...
                                        if (!ctx.partial && !("value" in _v219)) {
                                            ...
                                            if (Array.isArray(_v219["value"])) {
                                                ...
                                                const _v223 = { errors: [], partial: ctx.partial };
                                                let _v224 = false;
                                                if (!_v224) {
                                                    const _v225 = { errors: [], partial: _v223.partial };
                                                    validate_numberOrVariable(_v219["value"], _v225, path + "/variables" + "/" + _v189 + "/value");
                                                    if (_v225.errors.length === 0)
                                                        _v224 = true;
                                                }
                                                if (!_v224) {
                                    ...
                                    if (typeof _v188[_v189] !== "object" || _v188[_v189] === null) {
                                        ...
                                        if (!ctx.partial && !("value" in _v227)) {
                                            ...
                                            if (Array.isArray(_v227["value"])) {
                                                ...
                                                const _v231 = { errors: [], partial: ctx.partial };
                                                let _v232 = false;
                                                if (!_v232) {
                                                    const _v233 = { errors: [], partial: _v231.partial };
                                                    validate_stringOrVariable(_v227["value"], _v233, path + "/variables" + "/" + _v189 + "/value");
                                                    if (_v233.errors.length === 0)
                                                        _v232 = true;
                                                }
                                                if (!_v232) {
            ...
            if (!Array.isArray(_v175["children"])) {
                ...
                for (let _v235 = 0; _v235 < _v175["children"].length; _v235++) {
                    if (typeof _v175["children"][_v235] !== "object" || _v175["children"][_v235] === null) {
                        ...
                        const _v236 = _v175["children"][_v235];
                        switch (_v236["type"]) {
                            case "frame":
