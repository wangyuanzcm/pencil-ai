export function validate_variable(v, ctx, path) {
    if (typeof v !== "string") {
...
export function validate_booleanOrVariable(v, ctx, path) {
    if (typeof v === "string") {
...
export function validate_theme(v, ctx, path) {
...
export function validate_color(v, ctx, path) {
    if (typeof v !== "string") {
...
export function validate_colorOrVariable(v, ctx, path) {
    let _v5 = false;
    if (!_v5) {
...
export function validate_numberOrVariable(v, ctx, path) {
    if (typeof v === "string") {
...
export function validate_stringOrVariable(v, ctx, path) {
    let _v11 = false;
    if (!_v11) {
...
export function validate_position(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_canHaveRotation(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_entity(v, ctx, path) {
...
export function validate_sizingBehavior(v, ctx, path) {
    if (typeof v !== "string") {
...
export function validate_size(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_blendMode(v, ctx, path) {
...
export function validate_effect(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
...
export function validate_effects(v, ctx, path) {
    if (Array.isArray(v)) {
...
export function validate_canHaveEffects(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_fill(v, ctx, path) {
    let _v48 = false;
    if (!_v48) {
...
export function validate_fills(v, ctx, path) {
    if (Array.isArray(v)) {
...
export function validate_stroke(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_canHaveGraphics(v, ctx, path) {
...
export function validate_rectangleish(v, ctx, path) {
...
export function validate_layout(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_group(v, ctx, path) {
    validate_entity(v, ctx, path);
...
export function validate_rectangle(v, ctx, path) {
...
export function validate_ellipse(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_line(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_path(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_polygon(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_textStyle(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_textContent(v, ctx, path) {
    if (Array.isArray(v)) {
...
export function validate_text(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveGraphics(v, ctx, path);
...
export function validate_note(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_textStyle(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_prompt(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_textStyle(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_context(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_textStyle(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_iconFont(v, ctx, path) {
    validate_entity(v, ctx, path);
    validate_size(v, ctx, path);
    validate_canHaveEffects(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_idPath(v, ctx, path) {
    if (typeof v !== "string") {
...
export function validate_ref(v, ctx, path) {
    validate_entity(v, ctx, path);
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
...
export function validate_child(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
...
export function validate_canHaveChildren(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_frame(v, ctx, path) {
    validate_rectangleish(v, ctx, path);
    validate_canHaveChildren(v, ctx, path);
    validate_layout(v, ctx, path);
    if (typeof v !== "object" || v === null) {
...
export function validate_connectionAnchor(v, ctx, path) {
...
export function validate_connectionEndpoint(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
...
export function validate_connection(v, ctx, path) {
    validate_entity(v, ctx, path);
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
...
export function validate_document(v, ctx, path) {
    if (typeof v !== "object" || v === null) {
        ctx.errors.push({ path: path, message: "expected object" + ", got " + JSON.stringify(v) });
    }
    else {
