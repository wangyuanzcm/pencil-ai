...
exports.setBillingEnabled = setBillingEnabled;
 ...
 */
async function checkFeature(organizationId, featureKey, apiBase) {
    if (!_billingEnabled)
 ...
 */
async function recordUsage(organizationId, featureKey, apiBase, count = 1) {
    if (!_billingEnabled)
 ...
 */
async function checkAndRecordUsage(organizationId, featureKey, apiBase) {
    if (!_billingEnabled)
        return BILLING_DISABLED_CHECK;
