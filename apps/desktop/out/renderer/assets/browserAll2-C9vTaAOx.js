import { i as Qu, j as z_, L as LJ, k as XRt, m as h9, o as zq, q as qg, A as Av, p as X1 } from "./index-N39Y_uHT.js";
import "./webworkerAll2-g3ORvm_t.js";
(function() {
  try {
    var r = typeof window < "u" ? window : typeof global < "u" ? global : typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : {};
    r.SENTRY_RELEASE = { id: "24814d5198ee4ae2cafe869358a82d239d91bc34" };
  } catch {
  }
})();
try {
  (function() {
    ...
    e && (r._sentryDebugIds = r._sentryDebugIds || {}, r._sentryDebugIds[e] = "267d7a4a-2bbc-4fbc-a315-ffd268790b44", r._sentryDebugIdIdentifier = "sentry-dbid-267d7a4a-2bbc-4fbc-a315-ffd268790b44");
  })();
} catch {
}
class q {
  constructor(e) {
    this._lastTransform = "", this._observer = null, this._tickerAttached = false, this.updateTranslation = () => {
      ...
      const t = this._canvas.getBoundingClientRect(), i = this._canvas.width, n = this._canvas.height, s = t.width / i * this._renderer.resolution, o = t.height / n * this._renderer.resolution, a = t.left, l = t.top, d = `translate(${a}px, ${l}px) scale(${s}, ${o})`;
  ...
  _attachObserver() {
    ...
    }), this._observer.observe(this._canvas)) : this._tickerAttached || h9.shared.add(this.updateTranslation, this, zq.HIGH);
  }
  destroy() {
    this._observer ? (this._observer.disconnect(), this._observer = null) : this._tickerAttached && h9.shared.remove(this.updateTranslation), this._domElement = null, this._renderer = null, this._canvas = null, this._tickerAttached = false, this._lastTransform = "", this._lastScaleX = null, this._lastScaleY = null;
  }
}
class M {
  constructor(e) {
    this.bubbles = true, this.cancelBubble = true, this.cancelable = false, this.composed = false, this.defaultPrevented = false, this.eventPhase = M.prototype.NONE, this.propagationStopped = false, this.propagationImmediatelyStopped = false, this.layer = new qg(), this.page = new qg(), this.NONE = 0, this.CAPTURING_PHASE = 1, this.AT_TARGET = 2, this.BUBBLING_PHASE = 3, this.manager = e;
  }
  get layerX() {
    return this.layer.x;
  }
...
var I = /iPhone/i, L = /iPod/i, C = /iPad/i, U = /\biOS-universal(?:.+)Mac\b/i, k = /\bAndroid(?:.+)Mobile\b/i, R = /Android/i, E = /(?:SD4930UR|\bSilk(?:.+)Mobile\b)/i, O = /Silk/i, m = /Windows Phone/i, X = /\bWindows(?:.+)ARM\b/i, Y = /BlackBerry/i, H = /BB10/i, F = /Opera Mini/i, N = /\b(CriOS|Chrome)(?:.+)Mobile/i, $ = /Mobile(?:.+)Firefox\b/i, K = function(r) {
...
function G(r) {
  ...
  !r && typeof navigator < "u" ? e = { userAgent: navigator.userAgent, platform: navigator.platform, maxTouchPoints: navigator.maxTouchPoints || 0 } : typeof r == "string" ? e.userAgent = r : r && r.userAgent && (e = { userAgent: r.userAgent, platform: r.platform, maxTouchPoints: r.maxTouchPoints || 0 });
  var t = e.userAgent, i = t.split("[FBAN");
  typeof i[1] < "u" && (t = i[0]), i = t.split("Twitter"), typeof i[1] < "u" && (t = i[0]);
  var n = ne(t), s = { apple: { phone: n(I) && !n(m), ipod: n(L), tablet: !n(I) && (n(C) || K(e)) && !n(m), universal: n(U), device: (n(I) || n(L) || n(C) || n(U) || K(e)) && !n(m) }, amazon: { phone: n(E), tablet: !n(E) && n(O), device: n(E) || n(O) }, android: { phone: !n(m) && n(E) || !n(m) && n(k), tablet: !n(m) && !n(E) && !n(k) && (n(O) || n(R)), device: !n(m) && (n(E) || n(O) || n(k) || n(R)) || n(/\bokhttp\b/i) }, windows: { phone: n(m), tablet: n(X), device: n(m) || n(X) }, other: { blackberry: n(Y), blackberry10: n(H), opera: n(F), firefox: n($), chrome: n(N), device: n(Y) || n(H) || n(F) || n($) || n(N) }, any: false, phone: false, tablet: false };
...
const se = G.default ?? G, oe = se(globalThis.navigator), re = 9, W = 100, ae = 0, he = 0, j = 2, z = 1, le = -1e3, ce = -1e3, de = 2, S = class J {
  ...
  init(e) {
    const i = { accessibilityOptions: { ...J.defaultOptions, ...(e == null ? void 0 : e.accessibilityOptions) || {} } };
  ...
  postrender() {
    ...
    for (let i = this._children.length - 1; i >= 0; i--) {
      ...
      t.has(i) || (n._accessibleDiv && n._accessibleDiv.parentNode && (n._accessibleDiv.parentNode.removeChild(n._accessibleDiv), this._pool.push(n._accessibleDiv), n._accessibleDiv = null), n._accessibleActive = false, XRt(this._children, i, 1));
    }
    ...
    for (let i = 0; i < this._children.length; i++) {
      ...
      if (n.hitArea) {
        const a = n.worldTransform;
        s.style.left = `${a.tx + o.x * a.a}px`, s.style.top = `${a.ty + o.y * a.d}px`, s.style.width = `${o.width * a.a}px`, s.style.height = `${o.height * a.d}px`;
      } else this._capHitArea(o), s.style.left = `${o.x}px`, s.style.top = `${o.y}px`, s.style.width = `${o.width}px`, s.style.height = `${o.height}px`;
    }
    this._renderId++;
  }
  _updateDebugHTML(e) {
...
S.extension = { type: [Qu.WebGLSystem, Qu.WebGPUSystem], name: "accessibility" };
S.defaultOptions = { enabledByDefault: false, debug: false, activateOnTab: true, deactivateOnMouseMove: true };
let ue = S;
const pe = { accessible: false, accessibleTitle: null, accessibleHint: null, tabIndex: 0, accessibleType: "button", accessibleText: null, accessiblePointerEvents: "auto", accessibleChildren: true, _accessibleActive: false, _accessibleDiv: null, _renderId: -1 };
class Q {
  constructor(e) {
  ...
  init() {
    this._canvasObserver = new q({ domElement: this._domElement, renderer: this._renderer });
  }
  addRenderable(e, t) {
  ...
  postrender() {
    ...
    for (let t = 0; t < e.length; t++) {
      ...
      if (!i.parent || i.globalDisplayStatus < 7) n == null || n.remove(), e.splice(t, 1), t--;
      else {
        this._domElement.contains(n) || (n.style.position = "absolute", n.style.pointerEvents = "auto", this._domElement.appendChild(n));
        const s = i.worldTransform, o = i._anchor, a = i.width * o.x, l = i.height * o.y;
        n.style.transformOrigin = `${a}px ${l}px`, n.style.transform = `matrix(${s.a}, ${s.b}, ${s.c}, ${s.d}, ${s.tx - a}, ${s.ty - l})`, n.style.opacity = i.groupAlpha.toString();
      }
    }
  }
  destroy() {
    ...
    for (let t = 0; t < this._attachedDomElements.length; t++) (e = this._attachedDomElements[t].element) == null || e.remove();
    this._attachedDomElements.length = 0, this._domElement.remove(), this._canvasObserver.destroy(), this._renderer = null;
  }
}
Q.extension = { type: [Qu.WebGLPipes, Qu.WebGPUPipes, Qu.CanvasPipes], name: "dom" };
class ve {
  constructor() {
  ...
  addTickerListener() {
    this._tickerAdded || !this.domElement || (h9.system.add(this._tickerUpdate, this, zq.INTERACTION), this._tickerAdded = true);
  }
  removeTickerListener() {
    this._tickerAdded && (h9.system.remove(this._tickerUpdate, this), this._tickerAdded = false);
  }
  pointerMoved() {
    this._didMove = true;
  }
  _update() {
    ...
    this.events.supportsTouchEvents && e.pointerType === "touch" || globalThis.document.dispatchEvent(this.events.supportsPointerEvents ? new PointerEvent("pointermove", { clientX: e.clientX, clientY: e.clientY, pointerType: e.pointerType, pointerId: e.pointerId }) : new MouseEvent("mousemove", { clientX: e.clientX, clientY: e.clientY }));
  }
  _tickerUpdate(e) {
...
class D extends M {
  constructor() {
    super(...arguments), this.client = new qg(), this.movement = new qg(), this.offset = new qg(), this.global = new qg(), this.screen = new qg();
  }
  get clientX() {
  ...
  initMouseEvent(e, t, i, n, s, o, a, l, d, p, u, h, v, c, Ee) {
...
T.DOM_DELTA_LINE = 1;
T.DOM_DELTA_PAGE = 2;
const fe = 2048, me = new qg(), P = new qg();
class _e {
  constructor(e) {
    this.dispatch = new Av(), this.moveOnAll = false, this.enableGlobalMoveEvents = true, this.mappingState = { trackingData: {} }, this.eventPool = /* @__PURE__ */ new Map(), this._allInteractiveElements = [], this._hitElements = [], this._isPointerMoveEvent = false, this.rootTarget = e, this.hitPruneFn = this.hitPruneFn.bind(this), this.hitTestFn = this.hitTestFn.bind(this), this.mapPointerDown = this.mapPointerDown.bind(this), this.mapPointerMove = this.mapPointerMove.bind(this), this.mapPointerOut = this.mapPointerOut.bind(this), this.mapPointerOver = this.mapPointerOver.bind(this), this.mapPointerUp = this.mapPointerUp.bind(this), this.mapPointerUpOutside = this.mapPointerUpOutside.bind(this), this.mapWheel = this.mapWheel.bind(this), this.mappingTable = {}, this.addEventMapping("pointerdown", this.mapPointerDown), this.addEventMapping("pointermove", this.mapPointerMove), this.addEventMapping("pointerout", this.mapPointerOut), this.addEventMapping("pointerleave", this.mapPointerOut), this.addEventMapping("pointerover", this.mapPointerOver), this.addEventMapping("pointerup", this.mapPointerUp), this.addEventMapping("pointerupoutside", this.mapPointerUpOutside), this.addEventMapping("wheel", this.mapWheel);
  }
  addEventMapping(e, t) {
    this.mappingTable[e] || (this.mappingTable[e] = []), this.mappingTable[e].push({ fn: t, priority: 0 }), this.mappingTable[e].sort((i, n) => i.priority - n.priority);
  }
  dispatchEvent(e, t) {
  ...
  mapEvent(e) {
    ...
    else X1(`[EventBoundary]: Event mapping not defined for ${e.type}`);
  }
  hitTest(e, t) {
    y.pauseUpdate = true;
    const n = this._isPointerMoveEvent && this.enableGlobalMoveEvents ? "hitTestMoveRecursive" : "hitTestRecursive", s = this[n](this.rootTarget, this.rootTarget.eventMode, me.set(e, t), this.hitTestFn, this.hitPruneFn);
    return s && s[0];
  }
  propagate(e, t) {
    if (!e.target) return;
  ...
  hitTestMoveRecursive(e, t, i, n, s, o = false) {
    ...
    if ((e.eventMode === "dynamic" || t === "dynamic") && (y.pauseUpdate = false), e.interactiveChildren && e.children) {
      ...
      for (let u = p.length - 1; u >= 0; u--) {
        const h = p[u], v = this.hitTestMoveRecursive(h, this._isInteractive(t) ? t : h.eventMode, i, n, s, o || s(e, i));
        if (v) {
          if (v.length > 0 && !v[v.length - 1].parent) continue;
          const c = e.isInteractive();
          (v.length > 0 || c) && (c && this._allInteractiveElements.push(e), v.push(e)), this._hitElements.length === 0 && (this._hitElements = v), a = true;
        }
      }
    }
    const l = this._isInteractive(t), d = e.isInteractive();
    return d && d && this._allInteractiveElements.push(e), o || this._hitElements.length > 0 ? null : a ? this._hitElements : l && !s(e, i) && n(e, i) ? d ? [e] : [] : null;
  }
  hitTestRecursive(e, t, i, n, s) {
    ...
    if ((e.eventMode === "dynamic" || t === "dynamic") && (y.pauseUpdate = false), e.interactiveChildren && e.children) {
      ...
      for (let p = l.length - 1; p >= 0; p--) {
        const u = l[p], h = this.hitTestRecursive(u, this._isInteractive(t) ? t : u.eventMode, d, n, s);
        if (h) {
  ...
  hitPruneFn(e, t) {
    if (e.hitArea && (e.worldTransform.applyInverse(t, P), !e.hitArea.contains(P.x, P.y))) return true;
  ...
  hitTestFn(e, t) {
    return e.hitArea ? true : e != null && e.containsPoint ? (e.worldTransform.applyInverse(t, P), e.containsPoint(P)) : false;
  }
  notifyTarget(e, t) {
    var s, o;
  ...
  mapPointerDown(e) {
    if (!(e instanceof f)) {
      X1("EventBoundary cannot map a non-pointer event as a pointer event");
      return;
    }
  ...
  mapPointerUp(e) {
    ...
    if (o) {
      ...
      a.target = o, a.path = null, n.clicksByButton[e.button] || (n.clicksByButton[e.button] = { clickCount: 0, target: a.target, timeStamp: t });
      ...
      if (l.target === a.target && t - l.timeStamp < 200 ? ++l.clickCount : l.clickCount = 1, l.target = a.target, l.timeStamp = t, a.detail = l.clickCount, a.pointerType === "mouse") {
        const d = a.button === 2;
        this.dispatchEvent(a, d ? "rightclick" : "click");
  ...
  mapWheel(e) {
    if (!(e instanceof T)) {
      X1("EventBoundary cannot map a non-wheel event as a wheel event");
      return;
    }
...
const ge = 1, ye = { touchstart: "pointerdown", touchend: "pointerup", touchendoutside: "pointerupoutside", touchmove: "pointermove", touchcancel: "pointercancel" }, B = class x {
  constructor(e) {
    this.supportsTouchEvents = "ontouchstart" in globalThis, this.supportsPointerEvents = !!globalThis.PointerEvent, this.domElement = null, this.resolution = 1, this.renderer = e, this.rootBoundary = new _e(null), y.init(this), this.autoPreventDefault = true, this._eventsAdded = false, this._rootPointerEvent = new f(null), this._rootWheelEvent = new T(null), this.cursorStyles = { default: "inherit", pointer: "pointer" }, this.features = new Proxy({ ...x.defaultEventFeatures }, { set: (t, i, n) => (i === "globalMove" && (this.rootBoundary.enableGlobalMoveEvents = n), t[i] = n, true) }), this._onPointerDown = this._onPointerDown.bind(this), this._onPointerMove = this._onPointerMove.bind(this), this._onPointerUp = this._onPointerUp.bind(this), this._onPointerOverOut = this._onPointerOverOut.bind(this), this.onWheel = this.onWheel.bind(this);
  }
  ...
  mapPositionToPoint(e, t, i) {
    const n = this.domElement.isConnected ? this.domElement.getBoundingClientRect() : { width: this.domElement.width, height: this.domElement.height, left: 0, top: 0 }, s = 1 / this.resolution;
...
B.extension = { name: "events", type: [Qu.WebGLSystem, Qu.CanvasSystem, Qu.WebGPUSystem], priority: -1 };
B.defaultEventFeatures = { move: true, globalMove: true, click: true, wheel: true };
let ee = B;
const be = { onclick: null, onmousedown: null, onmouseenter: null, onmouseleave: null, onmousemove: null, onglobalmousemove: null, onmouseout: null, onmouseover: null, onmouseup: null, onmouseupoutside: null, onpointercancel: null, onpointerdown: null, onpointerenter: null, onpointerleave: null, onpointermove: null, onglobalpointermove: null, onpointerout: null, onpointerover: null, onpointertap: null, onpointerup: null, onpointerupoutside: null, onrightclick: null, onrightdown: null, onrightup: null, onrightupoutside: null, ontap: null, ontouchcancel: null, ontouchend: null, ontouchendoutside: null, ontouchmove: null, onglobaltouchmove: null, ontouchstart: null, onwheel: null, get interactive() {
...
}, interactiveChildren: true, hitArea: null, addEventListener(r, e, t) {
  ...
  if (!(r instanceof M)) throw new Error("Container cannot propagate events outside of the Federated Events API");
